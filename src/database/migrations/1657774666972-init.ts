...
export class init1657774666972 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
          ...
          ('QAManager',                     'b7488c81-1a2b-41b1-9f04-b101dc989075')
          ,('DepartmentManager',            '31501ab9-d508-4aea-8046-f92327efe1b3')
          ,('SuperAdmin',                   '70ebd45b-b0b1-41cf-8e19-53caf36be1c3')
          ,('OrganizationAdmin',            'ed12a0c4-0c16-4737-99d0-f15f6446f45d')
          ,('DisciplineLead',               '921db096-14a2-424d-bb7c-afd9eaee3022')
          ,('ProjectManager',               'd2a54247-3215-4e7c-8eda-754c314b2f33')
